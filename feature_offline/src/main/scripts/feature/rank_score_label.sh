...
filelist="$APP_HOME/conf/taichi.json,$APP_HOME/conf/log4j.properties"

export SPARK_CLASSPATH=$SPARK_CLASSPATH":$APP_HOME/conf:$APP_HOME/etc:$APP_HOME/libs/*"

cls="com.captain.bigdata.taichi.demo.app.RankScoreLabel"
...
cmd="$cmd --num-executors 100 --executor-cores 4 --executor-memory 10GB"
